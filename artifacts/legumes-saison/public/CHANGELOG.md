...
- Badge famille cliquable dans les fiches plantes → filtre encyclopédie
- Légende déplacée au-dessus de la grille du calendrier de semis
...
- Calendrier de semis avec décalage régional
- Planificateur de potager avec associations de plantes
- Carte des marchés bio locaux
- Sélecteur de région (Nord / Centre / Sud / Montagne)

---

## À venir

- Export PDF du calendrier personnalisé
- Mode sombre
- Partage et impression des plans de potager
- Recettes associées aux légumes de saison
- Alertes météo saisonnières localisées
- Gestion de plusieurs parcelles dans le potager
- Notifications pour les semis à venir
